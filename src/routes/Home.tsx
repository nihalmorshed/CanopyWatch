  ...
  return (
    <div className="space-y-6">
      ...
      <section className="animate-fade-up delay-300">
        <h2 className="text-lg font-display font-semibold mb-4 text-[var(--color-forest-700)] dark:text-[var(--color-cream-50)]">
          Quick Actions
        </h2>
        <div className="grid grid-cols-2 gap-4">
          <a
          ...
          >
            <div className="w-14 h-14 bg-[var(--color-forest-100)] dark:bg-[var(--color-forest-700)] rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg className="w-7 h-7 text-[var(--color-forest-600)] dark:text-[var(--color-forest-300)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" />
              </svg>
            </div>
            <span className="font-semibold text-[var(--color-forest-700)] dark:text-[var(--color-cream-50)]">
              Analyze Canopy
            </span>
          </a>
          <a
            ...
            className="card card-interactive p-5 text-center group"
          >
            <div className="w-14 h-14 bg-[var(--color-cream-200)] dark:bg-[var(--color-loam-700)] rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg className="w-7 h-7 text-[var(--color-terracotta-500)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
